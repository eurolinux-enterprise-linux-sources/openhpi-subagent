 ...
 *
 * $Id: saHpiDomainEventLogTable.c 5429 2005-11-14 22:23:12Z ddearauj $
 *
 *
...
int handle_saHpiDomainEventLogLifetimeChanges(netsnmp_mib_handler *handler,
                                        netsnmp_handler_registration *reginfo,
                                        netsnmp_agent_request_info   *reqinfo,
                                        netsnmp_request_info         *requests);
			  
int handle_saHpiDomainEventLogActiveEntries(netsnmp_mib_handler *handler,
                                        netsnmp_handler_registration *reginfo,
                                        netsnmp_agent_request_info   *reqinfo,
                                        netsnmp_request_info         *requests);			  

int initialize_table_saHpiDomainEventLogLifetimeChanges(void);
int initialize_table_saHpiDomainEventLogActiveEntries(void); 
                                        ...
                                        netsnmp_request_info         *requests)
{
        ...
        DEBUGMSGTL ((AGENT, "handle_saHpiDomainEventLogLifetimeChanges, called\n"));
                                ...
                                netsnmp_request_info         *requests)
{
        ...
        DEBUGMSGTL ((AGENT, "handle_saHpiDomainEventLogActiveEntries, called\n"));
...
int initialize_table_saHpiDomainEventLogActiveEntries(void)
{
        ...
        DEBUGMSGTL ((AGENT, "initialize_table_saHpiDomainEventLogActiveEntries, called\n"));

        netsnmp_register_scalar(
	                        netsnmp_create_handler_registration(
				        "saHpiDomainEventLogActiveEntries", 
					handle_saHpiDomainEventLogActiveEntries,
			                saHpiDomainEventLogActiveEntries_oid, 
					OID_LENGTH(saHpiDomainEventLogActiveEntries_oid),
			                HANDLER_CAN_RONLY ));
...
init_saHpiDomainEventLogTable(void)
{
	...
	initialize_table_saHpiDomainEventLogTable();
        ...
        initialize_table_saHpiDomainEventLogLifetimeChanges();
        initialize_table_saHpiDomainEventLogActiveEntries();
    ...
    switch(table_info->colnum) {
        ...
        case COLUMN_SAHPIDOMAINEVENTLOGENTRYID:
            ...
            snmp_set_var_typed_value(var, ASN_UNSIGNED,
                         (u_char*)&context->saHpiDomainEventLogEntryId,
        ...
        case COLUMN_SAHPIDOMAINEVENTLOGTYPE:
            ...
            snmp_set_var_typed_value(var, ASN_INTEGER,
                         (u_char*)&context->saHpiDomainEventLogType,
