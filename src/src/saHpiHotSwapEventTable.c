 ...
 *
 * $Id: saHpiHotSwapEventTable.c 5429 2005-11-14 22:23:12Z ddearauj $
 *
 *
...
int handle_saHpiHotSwapEventLifetimeChanges(netsnmp_mib_handler *handler,
...
int initialize_table_saHpiHotSwapEventLifetimeChanges(void);
                                        ...
                                        size_t *this_child_oid_len)
{
	...
	SaHpiDomainIdResourceIdArrayT dr_pair;
        ...
        DEBUGMSGTL ((AGENT, "populate_saHpiHotSwapEventTable, called\n"));

	/* check for NULL pointers */
	if (!event) {
		DEBUGMSGTL ((AGENT, 
		"ERROR: populate_saHpiHotSwapEventTable() passed NULL event pointer\n"));
	...
	if (dr_entry == NULL) {
		DEBUGMSGTL ((AGENT, 
		"ERROR: populate_saHpiHotSwapEventTable() domain_resource_pair_get returned NULL\n"));
...
SaErrorT async_hotswap_event_add(SaHpiSessionIdT sessionid, 
                                 SaHpiEventT *event,
				 SaHpiRdrT *rdr,
                                ...
                                netsnmp_request_info         *requests)
{
        ...
        DEBUGMSGTL ((AGENT, "handle_saHpiHotSwapEventLifetimeChanges, called\n"));
...
int initialize_table_saHpiHotSwapEventLifetimeChanges(void)
{
        ...
        DEBUGMSGTL ((AGENT, "initialize_table_saHpiHotSwapEventLifetimeChanges, called\n"));

        netsnmp_register_scalar(
                                netsnmp_create_handler_registration(
				        "saHpiHotSwapEventLifetimeChanges", 
					handle_saHpiHotSwapEventLifetimeChanges,
                                        saHpiHotSwapEventLifetimeChanges_oid, 
					OID_LENGTH(saHpiHotSwapEventLifetimeChanges_oid),
                                        HANDLER_CAN_RONLY ));
 ...
 */
static int saHpiHotSwapEventTable_cmp( const void *lhs, const void *rhs );
 ...
 */
static int
saHpiHotSwapEventTable_cmp( const void *lhs, const void *rhs )
{
        saHpiHotSwapEventTable_context *context_l =
        (saHpiHotSwapEventTable_context *)lhs;
        saHpiHotSwapEventTable_context *context_r =
        (saHpiHotSwapEventTable_context *)rhs;

        /*
         * check primary key, then secondary. Add your own code if
         * there are more than 2 indexes
         */
        DEBUGMSGTL ((AGENT, "saHpiHotSwapEventTable_cmp, called\n"));

        /* check for NULL pointers */
        if (lhs == NULL || rhs == NULL ) {
                DEBUGMSGTL((AGENT,"saHpiHotSwapEventTable_cmp() NULL pointer ERROR\n" ));
                return 0;
        }
...
init_saHpiHotSwapEventTable(void)
{
        ...
        initialize_table_saHpiHotSwapEventLifetimeChanges();
 ...
 */
static int saHpiHotSwapEventTable_row_copy(saHpiHotSwapEventTable_context * dst,
                         saHpiHotSwapEventTable_context * src)
{
    if(!dst||!src)
        return 1;
    ...
    dst->saHpiHotSwapEventPreviousState = src->saHpiHotSwapEventPreviousState;
...
saHpiHotSwapEventTable_extract_index( saHpiHotSwapEventTable_context * ctx, netsnmp_index * hdr )
{
        ...
        DEBUGMSGTL ((AGENT, "saHpiHotSwapEventTable_extract_index, called\n"));
                    ...
                    netsnmp_request_group * rg)
{
     ...
     * deactivate.
     */
    if(saHpiHotSwapEventTable_can_deactivate(undo_ctx,row_ctx,rg) != 1)
        return 0;
 ...
 *
 * returns a newly allocated saHpiHotSwapEventTable_context
 *   structure if the specified indexes are not illegal
 * returns NULL for errors or illegal index values.
 */
saHpiHotSwapEventTable_context *
saHpiHotSwapEventTable_create_row( netsnmp_index* hdr)
{
    
    subagent_lock(&hpi_lock_data);
    
    saHpiHotSwapEventTable_context * ctx =
     ...
     */
    if(saHpiHotSwapEventTable_extract_index( ctx, hdr )) {
        free(ctx->index.oids);
        free(ctx);
        subagent_unlock(&hpi_lock_data);
	return NULL;
 ...
 */
saHpiHotSwapEventTable_context *
saHpiHotSwapEventTable_duplicate_row( saHpiHotSwapEventTable_context * row_ctx)
{
    saHpiHotSwapEventTable_context * dup;
    ...
    dup = SNMP_MALLOC_TYPEDEF(saHpiHotSwapEventTable_context);
    if(!dup) {
	subagent_unlock(&hpi_lock_data);
        return NULL; }
        
    if(saHpiHotSwapEventTable_row_copy(dup,row_ctx)) {
        free(dup);
        dup = NULL;
    }
 ...
 */
netsnmp_index * saHpiHotSwapEventTable_delete_row( saHpiHotSwapEventTable_context * ctx )
{
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        default: /** We shouldn't get here */
            ...
            snmp_log(LOG_ERR, "unknown column in "
                     "saHpiHotSwapEventTable_set_reserve1\n");
        }
 ...
 */
void
initialize_table_saHpiHotSwapEventTable(void)
{
    netsnmp_table_registration_info *table_info;

    if(my_handler) {
        snmp_log(LOG_ERR, "initialize_table_saHpiHotSwapEventTable_handler called again\n");
        return;
    }
    ...
    my_handler = netsnmp_create_handler_registration("saHpiHotSwapEventTable",
                                             netsnmp_table_array_helper_handler,
                                             saHpiHotSwapEventTable_oid,
                                             saHpiHotSwapEventTable_oid_len,
                                             HANDLER_CAN_RWRITE);
            
    if (!my_handler || !table_info) {
        snmp_log(LOG_ERR, "malloc failed in "
                 "initialize_table_saHpiHotSwapEventTable_handler\n");
    ...
    table_info->min_column = saHpiHotSwapEventTable_COL_MIN;
    table_info->max_column = saHpiHotSwapEventTable_COL_MAX;

    /***************************************************
     * registering the table with the master agent
     */
    cb.get_value = saHpiHotSwapEventTable_get_value;
    ...
    cb.can_activate = (Netsnmp_User_Row_Action *)saHpiHotSwapEventTable_can_activate;
    cb.can_deactivate = (Netsnmp_User_Row_Action *)saHpiHotSwapEventTable_can_deactivate;
    cb.can_delete = (Netsnmp_User_Row_Action *)saHpiHotSwapEventTable_can_delete;

    cb.set_reserve1 = saHpiHotSwapEventTable_set_reserve1;
    cb.set_reserve2 = saHpiHotSwapEventTable_set_reserve2;
    cb.set_action = saHpiHotSwapEventTable_set_action;
...
/************************************************************
 * saHpiHotSwapEventTable_get_value
 *
 ...
 */
int saHpiHotSwapEventTable_get_value(
            netsnmp_request_info *request,
            netsnmp_index *item,
            netsnmp_table_request_info *table_info )
{
    netsnmp_variable_list *var = request->requestvb;
    saHpiHotSwapEventTable_context *context = (saHpiHotSwapEventTable_context *)item;
...
/************************************************************
 * saHpiHotSwapEventTable_get_by_idx
 */
const saHpiHotSwapEventTable_context *
saHpiHotSwapEventTable_get_by_idx(netsnmp_index * hdr)
{
    return (const saHpiHotSwapEventTable_context *)
