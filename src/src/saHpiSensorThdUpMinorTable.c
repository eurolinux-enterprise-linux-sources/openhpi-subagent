 ...
 *
 * $Id: saHpiSensorThdUpMinorTable.c 5427 2005-11-14 22:10:52Z djudkovi $
 *
 *
...
oid saHpiSensorThdUpMinorTable_oid[] = { saHpiSensorThdUpMinorTable_TABLE_OID};
size_t saHpiSensorThdUpMinorTable_oid_len = OID_LENGTH(saHpiSensorThdUpMinorTable_oid);
                                   ...
                                   SaHpiSensorThresholdsT *sensor_thresholds)
{
        ...
        saHpiSensorThdUpMinorTable_context *sen_thd_up_minor_ctx;

        /* check for NULL pointers */
        if (!rdr_entry) {
                DEBUGMSGTL ((AGENT, 
                             "ERROR: populate_sen_thd_up_minor() passed NULL rdr_entry pointer\n"));
	...
	/* BUILD oid for new row */
        ...
        sen_thd_up_minor_idx.len = SEN_THD_UP_MINOR_IDX_NR;
        /** Index saHpiDomainId is external */
        sen_thd_up_minor_oid[0] = get_domain_id(sessionid);
        /** Index saHpiResourceId is external */
        sen_thd_up_minor_oid[1] = rpt_entry->ResourceId;
        /** Index saHpiResourceIsHistorical is external */
        sen_thd_up_minor_oid[2] = MIB_FALSE;
        /** Index saHpiSensorNum */
        sen_thd_up_minor_oid[3] = rdr_entry->RdrTypeUnion.SensorRec.Num;
        /* assign the indices to the index */
        sen_thd_up_minor_idx.oids = (oid *) & sen_thd_up_minor_oid;

        /* See if Row exists. */
        sen_thd_up_minor_ctx = NULL;
        sen_thd_up_minor_ctx = CONTAINER_FIND(cb.container, &sen_thd_up_minor_idx);
        ...
        if (SAHPI_STM_UP_MINOR & 
            rdr_entry->RdrTypeUnion.SensorRec.ThresholdDefn.ReadThold) {
                sen_thd_up_minor_ctx->saHpiSensorThdUpMinorIsReadable =
                MIB_TRUE;
        } else {
                sen_thd_up_minor_ctx->saHpiSensorThdUpMinorIsReadable =
                MIB_FALSE;
        ...
        if (SAHPI_STM_UP_MINOR & 
            rdr_entry->RdrTypeUnion.SensorRec.ThresholdDefn.WriteThold) {
                sen_thd_up_minor_ctx->saHpiSensorThdUpMinorIsWritable =
                MIB_TRUE;
        } else {
                sen_thd_up_minor_ctx->saHpiSensorThdUpMinorIsWritable =
                MIB_FALSE;
        ...
        sen_thd_up_minor_ctx->saHpiSensorThdUpMinorType = 
        sensor_thresholds->UpMinor.Type + 1; 

        /** SaHpiSensorReadingValue = ASN_OCTET_STR */
        sen_thd_up_minor_ctx->saHpiSensorThdUpMinorValue_len =
        set_sensor_reading_value(&sensor_thresholds->UpMinor,
                                 sen_thd_up_minor_ctx->saHpiSensorThdUpMinorValue);

        /** TruthValue = ASN_INTEGER */
        sen_thd_up_minor_ctx->saHpiSensorThdUpMinorNonLinear = 
...

{
        ...
        saHpiSensorThdUpMinorTable_context *thd_ctx;

	DEBUGMSGTL ((AGENT, "clear_sen_thd_up_minor, called\n"));	
	...
	DEBUGMSGTL ((AGENT, "           resourceId [%d]\n", resourceId));
        ...
        if (row_idx) //At least one entry was found.
        {
                do {
                        ...
                        if ((thd_ctx->index.oids[saHpiThdUpMinDomainId_INDEX] ==
                             domainId) &&

                            (thd_ctx->index.oids[saHpiThdUpMinResourceEntryId_INDEX] ==
                             resourceId)) {

                                /* all conditions met remove row */
                                CONTAINER_REMOVE (cb.container, thd_ctx);
                                saHpiSensorThdUpMinorTable_delete_row (thd_ctx);
                                DEBUGMSGTL ((AGENT, "clear_sen_thd_up_minor: "
                                                    "found row: removing\n"));
...
int set_table_sen_thds_up_minor (saHpiSensorThdUpMinorTable_context *row_ctx)
{
        ...
        DEBUGMSGTL ((AGENT, "set_table_sen_thds_up_minor, called\n"));
        ...
        session_id = get_session_id(row_ctx->index.oids[saHpiThdUpMinDomainId_INDEX]);
        resource_id = row_ctx->index.oids[saHpiThdUpMinResourceEntryId_INDEX];
        sensor_num = row_ctx->index.oids[saHpiSensorThdUpMinNum_INDEX];

        memset(&sensor_thresholds, 0, sizeof(sensor_thresholds));

        sensor_thresholds.UpMinor.IsSupported = SAHPI_TRUE;
        sensor_thresholds.UpMinor.Type = row_ctx->saHpiSensorThdUpMinorType - 1;
        set_sen_thd_value(&sensor_thresholds.UpMinor.Value,
                          sensor_thresholds.UpMinor.Type,
                          row_ctx->saHpiSensorThdUpMinorValue, 
                          row_ctx->saHpiSensorThdUpMinorValue_len);
        ...
        if (rc != SA_OK) {
                snmp_log (LOG_ERR,
                          "SAHPI_STM_UP_MINOR: Call to saHpiSensorThresholdsSet failed to set Mode rc: %s.\n",
                          oh_lookup_error(rc));
                DEBUGMSGTL ((AGENT,
                             "SAHPI_STM_UP_MINOR: Call to saHpiSensorThresholdsSet failed to set Mode rc: %s.\n",
                             oh_lookup_error(rc)));
 ...
 */
static int saHpiSensorThdUpMinorTable_cmp( const void *lhs, const void *rhs );
 ...
 */
static int
saHpiSensorThdUpMinorTable_cmp( const void *lhs, const void *rhs )
{
        saHpiSensorThdUpMinorTable_context *context_l =
        (saHpiSensorThdUpMinorTable_context *)lhs;
        saHpiSensorThdUpMinorTable_context *context_r =
        (saHpiSensorThdUpMinorTable_context *)rhs;

        DEBUGMSGTL ((AGENT, "saHpiSensorThdUpMinorTable_cmp, called\n"));
...
/************************************************************
 * Initializes the saHpiSensorThdUpMinorTable module
 */
void
init_saHpiSensorThdUpMinorTable(void)
{
        DEBUGMSGTL ((AGENT, "init_saHpiSensorThdUpMinorTable, called\n"));
 ...
 */
static int saHpiSensorThdUpMinorTable_row_copy(saHpiSensorThdUpMinorTable_context * dst,
                                               saHpiSensorThdUpMinorTable_context * src)
{
        if (!dst||!src)
                return 1;

        DEBUGMSGTL ((AGENT, "saHpiSensorThdUpMinorTable_row_copy, called\n"));
        subagent_lock(&hpi_lock_data);
        ...
        dst->saHpiSensorThdUpMinorType = src->saHpiSensorThdUpMinorType;

        memcpy( dst->saHpiSensorThdUpMinorValue, src->saHpiSensorThdUpMinorValue, src->saHpiSensorThdUpMinorValue_len );
        dst->saHpiSensorThdUpMinorValue_len = src->saHpiSensorThdUpMinorValue_len;

        dst->saHpiSensorThdUpMinorNonLinear = src->saHpiSensorThdUpMinorNonLinear;
 ...
 */
int
saHpiSensorThdUpMinorTable_extract_index( saHpiSensorThdUpMinorTable_context * ctx, netsnmp_index * hdr )
{
        /*
        ...
        DEBUGMSGTL ((AGENT, "saHpiSensorThdUpMinorTable_extract_index, called\n"));
        subagent_lock(&hpi_lock_data);
...
{
        DEBUGMSGTL ((AGENT, "saHpiSensorThdUpMinorTable_can_activate, called\n"));
...
int saHpiSensorThdUpMinorTable_can_deactivate(saHpiSensorThdUpMinorTable_context *undo_ctx,
                                              ...
                                              netsnmp_request_group * rg)
{
        DEBUGMSGTL ((AGENT, "saHpiSensorThdUpMinorTable_can_deactivate, called\n"));
...
int saHpiSensorThdUpMinorTable_can_delete(saHpiSensorThdUpMinorTable_context *undo_ctx,
                                          ...
                                          netsnmp_request_group * rg)
{
        DEBUGMSGTL ((AGENT, "saHpiSensorThdUpMinorTable_can_delete, called\n"));
        /*
         * probably shouldn't delete a row that we can't
         * deactivate.
         */
        if (saHpiSensorThdUpMinorTable_can_deactivate(undo_ctx,row_ctx,rg) != 1)
                return 0;
...
saHpiSensorThdUpMinorTable_create_row( netsnmp_index* hdr)
{
        ...
        DEBUGMSGTL ((AGENT, "saHpiSensorThdUpMinorTable_create_row, called\n"));
         ...
         */
        /**
         ctx->saHpiSensorThdUpMinorValue = 0;
        */
 ...
 */
saHpiSensorThdUpMinorTable_context *
saHpiSensorThdUpMinorTable_duplicate_row( saHpiSensorThdUpMinorTable_context * row_ctx)
{
        saHpiSensorThdUpMinorTable_context * dup;

        DEBUGMSGTL ((AGENT, "saHpiSensorThdUpMinorTable_duplicate_row, called\n"));
 ...
 */
netsnmp_index * saHpiSensorThdUpMinorTable_delete_row( saHpiSensorThdUpMinorTable_context * ctx )
{
        /* netsnmp_mutex_destroy(ctx->lock); */

        DEBUGMSGTL ((AGENT, "saHpiSensorThdUpMinorTable_delete_row, called\n"));
        subagent_lock(&hpi_lock_data);
...
//        saHpiSensorThdUpMinorTable_context *undo_ctx = (saHpiSensorThdUpMinorTable_context *)rg->undo_info;
        ...
        DEBUGMSGTL ((AGENT, "saHpiSensorThdUpMinorTable_set_reserve2, called\n"));
 ...
 */
void saHpiSensorThdUpMinorTable_set_action( netsnmp_request_group *rg )
{
        netsnmp_variable_list *var;
        saHpiSensorThdUpMinorTable_context *row_ctx = (saHpiSensorThdUpMinorTable_context *)rg->existing_row;
//        saHpiSensorThdUpMinorTable_context *undo_ctx = (saHpiSensorThdUpMinorTable_context *)rg->undo_info;
        ...
        DEBUGMSGTL ((AGENT, "saHpiSensorThdUpMinorTable_set_action, called\n"));
        ...
        for ( current = rg->list; current; current = current->next ) {
                ...
                case COLUMN_SAHPISENSORTHDUPMINORVALUE:
                        /** SaHpiSensorReadingValue = ASN_OCTET_STR */
                        memcpy(row_ctx->saHpiSensorThdUpMinorValue, var->val.string,
                               var->val_len);
                        row_ctx->saHpiSensorThdUpMinorValue_len = var->val_len;
                        row_err = set_table_sen_thds_up_minor (row_ctx);
                        break;
 ...
 */
int saHpiSensorThdUpMinorTable_get_value(
                                        netsnmp_request_info *request,
                                        netsnmp_index *item,
                                        netsnmp_table_request_info *table_info )
{
        netsnmp_variable_list *var = request->requestvb;
        saHpiSensorThdUpMinorTable_context *context = (saHpiSensorThdUpMinorTable_context *)item;

        DEBUGMSGTL ((AGENT, "saHpiSensorThdUpMinorTable_get_value, called\n"));
        ...
        case COLUMN_SAHPISENSORTHDUPMINORISREADABLE:
                ...
                snmp_set_var_typed_value(var, ASN_INTEGER,
                                         (u_char*)&context->saHpiSensorThdUpMinorIsReadable,
                                         sizeof(context->saHpiSensorThdUpMinorIsReadable) );
                break;

        case COLUMN_SAHPISENSORTHDUPMINORISWRITABLE:
                /** TruthValue = ASN_INTEGER */
                snmp_set_var_typed_value(var, ASN_INTEGER,
                                         (u_char*)&context->saHpiSensorThdUpMinorIsWritable,
                                         sizeof(context->saHpiSensorThdUpMinorIsWritable) );
                break;

        case COLUMN_SAHPISENSORTHDUPMINORTYPE:
                /** SaHpiSensorReadingType = ASN_INTEGER */
                snmp_set_var_typed_value(var, ASN_INTEGER,
                                         (u_char*)&context->saHpiSensorThdUpMinorType,
                                         sizeof(context->saHpiSensorThdUpMinorType) );
                break;

        case COLUMN_SAHPISENSORTHDUPMINORVALUE:
                /** SaHpiSensorReadingValue = ASN_OCTET_STR */
                snmp_set_var_typed_value(var, ASN_OCTET_STR,
                                         (u_char*)&context->saHpiSensorThdUpMinorValue,
                                         context->saHpiSensorThdUpMinorValue_len );
                break;

        case COLUMN_SAHPISENSORTHDUPMINORNONLINEAR:
                /** TruthValue = ASN_INTEGER */
                snmp_set_var_typed_value(var, ASN_INTEGER,
                                         (u_char*)&context->saHpiSensorThdUpMinorNonLinear,
                                         sizeof(context->saHpiSensorThdUpMinorNonLinear) );
                break;
...
/************************************************************
 * saHpiSensorThdUpMinorTable_get_by_idx
 */
const saHpiSensorThdUpMinorTable_context *
saHpiSensorThdUpMinorTable_get_by_idx(netsnmp_index * hdr)
{
        DEBUGMSGTL ((AGENT, "saHpiSensorThdUpMinorTable_get_by_idx, called\n"));

        return(const saHpiSensorThdUpMinorTable_context *)
