 ...
 *
 * $Id: saHpiResourceTable.c 5421 2005-11-14 21:02:01Z djudkovi $
 *
 *
...
{       
	...
	do {
		...
		/** BITS = ASN_OCTET_STR */
                hotswap_cap_map(&hs_cap, &RptEntry);
...
DEBUGMSGTL ((AGENT, "*****************************\n"));
	...
	if (rv != SA_OK) {
		DEBUGMSGTL ((AGENT, 
			     "async_event_resource: saHpiDomainInfoGet() Failed: rv = %d\n",
			     rv));
		return AGENT_ERR_INTERNAL_ERROR;
	}
