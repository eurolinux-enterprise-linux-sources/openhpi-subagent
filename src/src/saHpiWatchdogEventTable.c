 ...
 *
 * $Id: saHpiWatchdogEventTable.c 5428 2005-11-14 22:19:59Z djudkovi $
 *
 *
...
oid saHpiWatchdogEventTable_oid[] = { saHpiWatchdogEventTable_TABLE_OID };
...
int handle_saHpiWatchdogEventLifetimeChanges(netsnmp_mib_handler *handler,
                                        netsnmp_handler_registration *reginfo,
                                        netsnmp_agent_request_info   *reqinfo,
                                        netsnmp_request_info         *requests);

int handle_saHpiWatchdogEventActiveEntries(netsnmp_mib_handler *handler,
                                        netsnmp_handler_registration *reginfo,
                                        netsnmp_agent_request_info   *reqinfo,
                                        netsnmp_request_info         *requests);


int initialize_table_saHpiWatchdogEventLifetimeChanges(void);
int initialize_table_saHpiWatchdogEventActiveEntries(void); 
                                        ...
                                        netsnmp_request_info         *requests)
{
        ...
        DEBUGMSGTL ((AGENT, "handle_saHpiWatchdogEventLifetimeChanges, called\n"));
                                ...
                                netsnmp_request_info         *requests)
{
        ...
        DEBUGMSGTL ((AGENT, "handle_saHpiWatchdogEventActiveEntries, called\n"));
...
int initialize_table_saHpiWatchdogEventLifetimeChanges(void)
{
        ...
        DEBUGMSGTL ((AGENT, "initialize_table_saHpiWatchdogEventLifetimeChanges, called\n"));

        netsnmp_register_scalar(
                                netsnmp_create_handler_registration(
				        "saHpiWatchdogEventLifetimeChanges", 
					 handle_saHpiWatchdogEventLifetimeChanges,
                                         saHpiWatchdogEventLifetimeChanges_oid, 
					 OID_LENGTH(saHpiWatchdogEventLifetimeChanges_oid),
                                         HANDLER_CAN_RONLY ));
...
int initialize_table_saHpiWatchdogEventActiveEntries(void)
{
        ...
        DEBUGMSGTL ((AGENT, "initialize_table_saHpiWatchdogEventActiveEntries, called\n"));

        netsnmp_register_scalar(
                                netsnmp_create_handler_registration(
				        "saHpiWatchdogEventActiveEntries", 
					handle_saHpiWatchdogEventActiveEntries,
                                        saHpiWatchdogEventActiveEntries_oid, 
					OID_LENGTH(saHpiWatchdogEventActiveEntries_oid),
                                        HANDLER_CAN_RONLY ));
 ...
 */
static int saHpiWatchdogEventTable_cmp( const void *lhs, const void *rhs );
...
init_saHpiWatchdogEventTable(void)
{
	...
	initialize_table_saHpiWatchdogEventTable();
        ...
        initialize_table_saHpiWatchdogEventLifetimeChanges();
        initialize_table_saHpiWatchdogEventActiveEntries();
 ...
 */
static int saHpiWatchdogEventTable_row_copy(saHpiWatchdogEventTable_context * dst,
                         saHpiWatchdogEventTable_context * src)
{
    if(!dst||!src)
        return 1;
    ...
    dst->saHpiWatchdogEventUse = src->saHpiWatchdogEventUse;
                    ...
                    netsnmp_request_group * rg)
{
     ...
     * deactivate.
     */
    if(saHpiWatchdogEventTable_can_deactivate(undo_ctx,row_ctx,rg) != 1)
        return 0;
 ...
 *
 * returns a newly allocated saHpiWatchdogEventTable_context
 *   structure if the specified indexes are not illegal
 * returns NULL for errors or illegal index values.
 */
saHpiWatchdogEventTable_context *
saHpiWatchdogEventTable_create_row( netsnmp_index* hdr)
{
    saHpiWatchdogEventTable_context * ctx =
     ...
     */
    if(saHpiWatchdogEventTable_extract_index( ctx, hdr )) {
        free(ctx->index.oids);
        free(ctx);
        subagent_unlock(&hpi_lock_data);
        return NULL;
 ...
 */
saHpiWatchdogEventTable_context *
saHpiWatchdogEventTable_duplicate_row( saHpiWatchdogEventTable_context * row_ctx)
{
    saHpiWatchdogEventTable_context * dup;
    ...
    dup = SNMP_MALLOC_TYPEDEF(saHpiWatchdogEventTable_context);
    if(!dup) {
            subagent_unlock(&hpi_lock_data);
            return NULL;
    }
        
    if(saHpiWatchdogEventTable_row_copy(dup,row_ctx)) {
        free(dup);
        dup = NULL;
    }
 ...
 */
netsnmp_index * saHpiWatchdogEventTable_delete_row( saHpiWatchdogEventTable_context * ctx )
{
 ...
 */
void saHpiWatchdogEventTable_set_reserve1( netsnmp_request_group *rg )
{
//    saHpiWatchdogEventTable_context *row_ctx =
//            (saHpiWatchdogEventTable_context *)rg->existing_row;
//    saHpiWatchdogEventTable_context *undo_ctx =
//            (saHpiWatchdogEventTable_context *)rg->undo_info;
    ...
    for( current = rg->list; current; current = current->next ) {
        ...
        default: /** We shouldn't get here */
            ...
            snmp_log(LOG_ERR, "unknown column in "
                     "saHpiWatchdogEventTable_set_reserve1\n");
        }
...
void saHpiWatchdogEventTable_set_reserve2( netsnmp_request_group *rg )
{
//    saHpiWatchdogEventTable_context *row_ctx = (saHpiWatchdogEventTable_context *)rg->existing_row;
//    saHpiWatchdogEventTable_context *undo_ctx = (saHpiWatchdogEventTable_context *)rg->undo_info;
    netsnmp_request_group_item *current;
    netsnmp_variable_list *var;
    int rc;
 ...
 */
void saHpiWatchdogEventTable_set_action( netsnmp_request_group *rg )
{
    netsnmp_variable_list *var;
//    saHpiWatchdogEventTable_context *row_ctx = (saHpiWatchdogEventTable_context *)rg->existing_row;
//    saHpiWatchdogEventTable_context *undo_ctx = (saHpiWatchdogEventTable_context *)rg->undo_info;
 ...
 * undo_info.
 */
void saHpiWatchdogEventTable_set_commit( netsnmp_request_group *rg )
{
    netsnmp_variable_list *var;
//    saHpiWatchdogEventTable_context *row_ctx = (saHpiWatchdogEventTable_context *)rg->existing_row;
//    saHpiWatchdogEventTable_context *undo_ctx = (saHpiWatchdogEventTable_context *)rg->undo_info;
 ...
 */
void saHpiWatchdogEventTable_set_free( netsnmp_request_group *rg )
{
    netsnmp_variable_list *var;
//    saHpiWatchdogEventTable_context *row_ctx = (saHpiWatchdogEventTable_context *)rg->existing_row;
//    saHpiWatchdogEventTable_context *undo_ctx = (saHpiWatchdogEventTable_context *)rg->undo_info;
 ...
 * == 1).
 */
void saHpiWatchdogEventTable_set_undo( netsnmp_request_group *rg )
{
    netsnmp_variable_list *var;
//    saHpiWatchdogEventTable_context *row_ctx = (saHpiWatchdogEventTable_context *)rg->existing_row;
//    saHpiWatchdogEventTable_context *undo_ctx = (saHpiWatchdogEventTable_context *)rg->undo_info;
...
/************************************************************
 *
 * Initialize the saHpiWatchdogEventTable table by defining its contents and how it's structured
 */
void
initialize_table_saHpiWatchdogEventTable(void)
{
    netsnmp_table_registration_info *table_info;

    if(my_handler) {
        snmp_log(LOG_ERR, "initialize_table_saHpiWatchdogEventTable_handler called again\n");
        return;
    }
    ...
    my_handler = netsnmp_create_handler_registration("saHpiWatchdogEventTable",
                                             netsnmp_table_array_helper_handler,
                                             saHpiWatchdogEventTable_oid,
                                             saHpiWatchdogEventTable_oid_len,
                                             HANDLER_CAN_RWRITE);
            
    if (!my_handler || !table_info) {
        snmp_log(LOG_ERR, "malloc failed in "
                 "initialize_table_saHpiWatchdogEventTable_handler\n");
    ...
    table_info->min_column = saHpiWatchdogEventTable_COL_MIN;
    table_info->max_column = saHpiWatchdogEventTable_COL_MAX;

    /***************************************************
     * registering the table with the master agent
     */
    cb.get_value = saHpiWatchdogEventTable_get_value;
    ...
    cb.can_activate = (Netsnmp_User_Row_Action *)saHpiWatchdogEventTable_can_activate;
    cb.can_deactivate = (Netsnmp_User_Row_Action *)saHpiWatchdogEventTable_can_deactivate;
    cb.can_delete = (Netsnmp_User_Row_Action *)saHpiWatchdogEventTable_can_delete;

    cb.set_reserve1 = saHpiWatchdogEventTable_set_reserve1;
    cb.set_reserve2 = saHpiWatchdogEventTable_set_reserve2;
    cb.set_action = saHpiWatchdogEventTable_set_action;
...
/************************************************************
 * saHpiWatchdogEventTable_get_value
 *
 ...
 */
int saHpiWatchdogEventTable_get_value(
            netsnmp_request_info *request,
            netsnmp_index *item,
            netsnmp_table_request_info *table_info )
{
    netsnmp_variable_list *var = request->requestvb;
    saHpiWatchdogEventTable_context *context = (saHpiWatchdogEventTable_context *)item;
...
/************************************************************
 * saHpiWatchdogEventTable_get_by_idx
 */
const saHpiWatchdogEventTable_context *
saHpiWatchdogEventTable_get_by_idx(netsnmp_index * hdr)
{
    return (const saHpiWatchdogEventTable_context *)
